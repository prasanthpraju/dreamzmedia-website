...
const Footer = () => {
  ...
  const contactInfo = [
    {
      ...
      text: "123 Arcod Road, Vadapalani, Chennai - 600017",
    },
  ...
  return (
    <footer
      ref={footerRef}
      className="relative bg-gray-900 text-white overflow-hidden font-sans"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-20">
        <div
          className={`grid lg:grid-cols-12 gap-12 lg:gap-16 transition-all duration-1000 ${
        ...
        >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-gray-400 font-light leading-relaxed">
              Crafting unforgettable experiences in Chennai since 2010. We blend
              strategy, creativity, and technology to bring your vision to life.
            </p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <h4 className="text-sm font-bold uppercase tracking-widest text-pink-500 mb-6">
              Explore
            </h4>
          ...
          <div className="lg:col-span-4 space-y-6">
              ...
              {contactInfo.map((info, i) => (
                <div key={i} className="flex items-start group">
                  <div className="mt-1 w-8 h-8 rounded-full bg-white/5 flex items-center justify-center mr-4 group-hover:bg-pink-900 transition-colors">
                    <i
                      className={`${info.icon} text-xs text-gray-400 group-hover:text-white`}
                    ></i>
                  </div>
            ...
            <div className="pt-6">
              <Link to="/contact">
                <button className="w-full sm:w-auto cursor-pointer bg-white text-gray-900 px-8 py-3 rounded-sm font-bold uppercase text-xs tracking-widest hover:bg-pink-900 hover:text-white transition-all duration-300">

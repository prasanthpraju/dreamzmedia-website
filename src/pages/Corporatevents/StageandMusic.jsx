...
import serial1 from "../../assets/StageandMusicShow/sd.png";
import serial2 from "../../assets/StageandMusicShow/sd1.png";
import serial3 from "../../assets/StageandMusicShow/sd2.png";
import serial4 from "../../assets/StageandMusicShow/sd3.png";
import serial5 from "../../assets/StageandMusicShow/sd4.png";
import serial6 from "../../assets/StageandMusicShow/sd5.png";
import serial7 from "../../assets/StageandMusicShow/sd6.png";
import serial8 from "../../assets/StageandMusicShow/sd7.png";
          ...
          {images.map((image) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center backdrop-blur-[2px]">
                {/* UPDATED BUTTON: Smaller padding (px-4 py-2) and smaller text (text-[10px]) */}
                <button className="bg-white text-pink-950 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500 shadow-xl border border-white cursor-pointer hover:bg-pink-900 hover:text-white hover:border-pink-900">
                  Quick View
                </button>
              </div>
            </div>

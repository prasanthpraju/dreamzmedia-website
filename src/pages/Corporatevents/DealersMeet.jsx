...
import c1 from "../../assets/DealersMeet/d1.png";
import c2 from "../../assets/DealersMeet/d2.png";
import c3 from "../../assets/DealersMeet/d3.png";
import c4 from "../../assets/DealersMeet/d4.png";
import c5 from "../../assets/DealersMeet/d5.png";
import c6 from "../../assets/DealersMeet/d6.png";
import c7 from "../../assets/DealersMeet/d7.png";
import c8 from "../../assets/DealersMeet/d8.png";
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "DealersMeet" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
          ...
          {images.map((image) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center backdrop-blur-[2px]">
                {/* Reduced button size (px-4 py-2) and text size (text-[10px]) */}

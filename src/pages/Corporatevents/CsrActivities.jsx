...
import serial1 from "../../assets/CSRActivities/csr1.png";
import serial2 from "../../assets/CSRActivities/csr2.png";
import serial3 from "../../assets/CSRActivities/csr3.png";
import serial4 from "../../assets/CSRActivities/csr4.png";
import serial5 from "../../assets/CSRActivities/csr5.png";
import serial6 from "../../assets/CSRActivities/csr6.png";
import serial7 from "../../assets/CSRActivities/csr7.png";
import serial8 from "../../assets/CSRActivities/csr8.png";
        ...
        <div className="flex-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {images.map((image) => (
            <div
              ...
              // Changed: Added rounded-md for softer corners, kept the aspect ratio
              className="group relative aspect-[3/4] overflow-hidden bg-gray-100 cursor-pointer shadow-sm hover:shadow-xl transition-all duration-500 rounded-md"
            >
              <img
                src={image.src}
                alt=""
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center backdrop-blur-[1px]">
                {/* Improved Button: Smaller, sleeker, and sharper animation */}
                <button className="bg-white text-pink-950 px-5 py-2.5 text-[10px] font-bold uppercase tracking-[0.25em] transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 shadow-lg border border-white hover:bg-pink-900 hover:text-white hover:border-pink-900">
                  Quick View
                </button>
              </div>
            </div>

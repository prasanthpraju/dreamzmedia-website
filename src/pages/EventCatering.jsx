    ...
    <div className="event-catering-page">
      <div className="catering-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Events Catering</h2>
          
          <p className="content-description">
            Delight your guests with exceptional culinary experiences tailored to your event. 
            From intimate gatherings to grand celebrations, our catering services combine 

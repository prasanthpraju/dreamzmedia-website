...
const CorporateGift = () => {
  ...
  const giftImages = [
    {
      ...
      category: "premium",
      description:
        "Premium gift sets for executives and VIP clients with custom branding",
    },
    {
      id: 2,
      ...
      category: "branding",
      description:
        "Custom branded merchandise for corporate events and promotions",
    },
    {
      id: 3,
      ...
      category: "seasonal",
      description: "Special gift hampers for festive seasons and celebrations",
    },
    {
      id: 4,
      ...
      category: "packaging",
      description: "Customized packaging solutions for corporate gifting",
    },
    {
      id: 5,
      ...
      description: "Environmentally friendly corporate gift options",
    },
    {
      id: 6,
      ...
      title: "Luxury Gift Items",
      category: "luxury",
      description:
        "High-end luxury gifts for special occasions and VIP clients",
    },
  ];

  const filteredImages = giftImages.filter(
    (image) =>
  ...
  const openModal = (image) => {
    const index = giftImages.findIndex((img) => img.id === image.id);
  ...
  const nextImage = () => {
    const nextIndex = (currentIndex + 1) % giftImages.length;
    setCurrentIndex(nextIndex);
    setSelectedImage(giftImages[nextIndex]);
  };

  const prevImage = () => {
    const prevIndex =
      currentIndex === 0 ? giftImages.length - 1 : currentIndex - 1;
    setCurrentIndex(prevIndex);
    setSelectedImage(giftImages[prevIndex]);
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative pt-24 pb-16 lg:pt-32 lg:pb-80 bg-gradient-to-br from-pink-900 via-pink-100 to-pink-100">
        <div
...
Elevate your corporate relationships with bespoke gifting solutions that make lasting impressions
</p> */}
        </div>
      </div>
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-pink-25 rounded-2xl p-8 mb-8 shadow-lg border border-pink-100">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-pink-700 mb-6 leading-relaxed">
                  Strengthen business relationships with thoughtfully curated
                  corporate gifts. From branded merchandise to luxury gift sets,
                  we offer personalized solutions that leave a lasting
                ...
                <div className="relative max-w-md">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent bg-white text-pink-900 placeholder-pink-400 shadow-sm"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 px-2">
              <p className="text-pink-700 font-semibold">
                Showing {filteredImages.length} of {giftImages.length} gift
                options
                {searchTerm && (
                  <span className="text-pink-500 ml-2">for "{searchTerm}"</span>
                )}
              </p>
            </div>
            ...
            {filteredImages.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredImages.map((image) => (
                  <div
                    key={image.id}
                    className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-pink-100 group"
                  >
                    ...
                    <div className="p-5">
                      <div className="flex justify-between items-start mb-3">
                        <h3 className="font-bold text-pink-900 text-lg leading-tight">
                          {image.title}
                        </h3>
              ...
              <div className="text-center py-16 bg-gradient-to-br from-pink-50 to-white rounded-2xl border border-pink-100">
                <div className="flex justify-center mb-4">
                  <svg
                    className="w-20 h-20 text-pink-300"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                  >
                ...
                <p className="text-pink-700 text-lg max-w-md mx-auto">
                  Try adjusting your search terms or browse all gift categories
                </p>
                {searchTerm && (
                  <button
          ...
          >
            ...
            {giftImages.length > 1 && (
              <div className="absolute top-4 left-4 bg-black/50 text-white px-3 py-1 rounded-full text-sm font-semibold z-20">
                {currentIndex + 1} / {giftImages.length}
              </div>
            )}
            ...
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="lg:w-1/2 p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-pink-700 text-lg mb-8 leading-relaxed">

...
const StageandMusic = () => {
  ...
  return (
    <div className="stage-music-page">
      <div className="stage-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Stage and Music Show</h2>
          
          <p className="content-description">
            Elevate your events with professional stage setups and music performances. 
            From intimate gatherings to large-scale concerts, we deliver unforgettable 
            audio-visual experiences with state-of-the-art equipment.
          </p>
          ...
          {filteredImages.length === 0 && (
            <div className="no-results">
              <p>No stage setups found matching your search.</p>
            </div>
          )}
        </div>
      </div>

...
const Lightandsound = () => {
  ...
  const filteredImages = lightSoundImages.filter(image =>
  ...
  return (
    <div className="lightandsound-page">
      <div className="lightandsound-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Light & Sound</h2>
          
          <p className="content-description">
            Professional lighting and sound equipment for school events. 
            We provide crystal-clear audio systems and stunning visual effects 
            that enhance performances and create memorable experiences for students and audiences.
          </p>
          ...
          <div className="search-container">
            <div className="search-box">
              ...
              <input
                type="text"
                placeholder="Search light & sound equipment..."
          ...
          {filteredImages.length === 0 && (
            <div className="no-results">
              <p>No light & sound equipment found matching your search.</p>
            </div>
          )}
        </div>
      </div>

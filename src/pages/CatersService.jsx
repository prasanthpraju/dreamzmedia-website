...
const CatersService = () => {
  ...
  const cateringImages = [
    ...
    {
      id: 5,
      src: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2068&q=80",
    ...
    },
    {
      ...
      title: "Cocktail Appetizers",
      category: "appetizers"
    }
  ];

  const filteredImages = cateringImages.filter(image =>
  ...
  return (
    <div className="caters-service-page">
      <div className="caters-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Caters Service</h2>
          
          <p className="content-description">
            Delight your guests with exceptional culinary experiences tailored to your wedding. 
            From lavish buffets to elegant plated dinners, our catering services combine 
            exquisite flavors with impeccable presentation for memorable dining experiences.
          </p>
          ...
          {filteredImages.length === 0 && (
            <div className="no-results">
              <p>No catering services found matching your search.</p>
            </div>
          )}
        </div>
      </div>

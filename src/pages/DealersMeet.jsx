  ...
  const dealersMeetImages = [
    {
      ...
      title: "Dealer Network Meeting",
      category: "networking",
      description: "Strategic networking events to strengthen dealer relationships and foster collaboration"
    },
    {
      id: 2,
      ...
      category: "launch",
      description: "Memorable product launch events that create excitement and drive sales"
    },
    {
      id: 3,
      src: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      title: "Dealer Awards Ceremony",
      category: "awards",
      description: "Prestigious award ceremonies to recognize and reward top-performing dealers"
    },
    {
      id: 4,
      ...
      category: "training",
      description: "Comprehensive training sessions to enhance dealer knowledge and skills"
    },
    {
      id: 5,
      ...
      category: "exhibition",
      description: "Professional exhibition setups to showcase products and services effectively"
    },
    {
      id: 6,
      ...
      category: "strategy",
      description: "Strategic discussion forums to align business goals and drive growth"
    }
  ];

  const filteredImages = dealersMeetImages.filter(image =>
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-pink-25 rounded-2xl p-8 mb-8 shadow-lg border border-pink-100">
              <div className="max-w-2xl">
                <h2 className="text-3xl font-bold text-pink-900 mb-4">
                  Professional Dealer Events
                </h2>
                <p className="text-lg text-pink-700 mb-6 leading-relaxed">
                  From networking events to product launches, we create memorable experiences 
                  that strengthen your dealer relationships and drive business success through 
                ...
                <div className="relative max-w-md">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent bg-white text-gray-900 placeholder-black shadow-sm"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 px-2">
              <p className="text-pink-700 font-semibold">
                Showing {filteredImages.length} of {dealersMeetImages.length} dealer events
                {searchTerm && (
            ...
            {filteredImages.length > 0 ? (
              ...
              <div className="text-center py-16 bg-gradient-to-br from-pink-50 to-white rounded-2xl border border-pink-100">
                ...
                <p className="text-pink-700 text-lg max-w-md mx-auto">
                  Try adjusting your search terms or browse all event categories
                </p>
                {searchTerm && (
                  <button 

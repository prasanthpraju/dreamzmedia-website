...
const CorporateGift = () => {
  ...
  return (
    <div className="corporate-gift-page">
      <div className="gift-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Corporate Gift</h2>
          
          <p className="content-description">
            Strengthen business relationships with thoughtfully curated corporate gifts. 
            From branded merchandise to luxury gift sets, we offer personalized solutions 
            that leave a lasting impression on your clients and partners.
          </p>
          ...
          {filteredImages.length === 0 && (
           <div className="no-results">
              <p>No corporate gifts found matching your search.</p>
            </div>
          )}
        </div>
      </div>

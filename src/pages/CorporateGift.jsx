...
const CorporateGift = () => {
  ...
  const giftImages = [
    {
      ...
      category: "premium",
      description: "Premium gift sets for executives and VIP clients with custom branding"
    },
    {
      id: 2,
      ...
      category: "branding",
      description: "Custom branded merchandise for corporate events and promotions"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      category: "luxury",
      description: "High-end luxury gifts for special occasions and VIP clients"
    }
  ];
  ...
  const prevImage = () => {
    const prevIndex = currentIndex === 0 ? giftImages.length - 1 : currentIndex - 1;
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-pink-25 rounded-2xl p-8 mb-8 shadow-lg border border-pink-100">
              <div className="max-w-4xl">
                <h1 className="text-4xl lg:text-5xl font-bold text-pink-900 mb-6">
                  Corporate Gifting Excellence
                </h1>
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h2 className="text-2xl font-bold text-pink-800 mb-4">Why Choose Our Corporate Gifts?</h2>
                    <p className="text-lg text-pink-700 mb-4 leading-relaxed">
                      Transform your business relationships with thoughtfully curated corporate gifts 
                      that speak volumes about your brand's commitment to excellence and attention to detail.
                    </p>
                    {/* <p className="text-lg text-pink-700 mb-6 leading-relaxed">
                      Our bespoke gifting solutions are designed to strengthen partnerships, 
                      reward loyalty, and create memorable experiences that extend far beyond 
                      the boardroom.
                    </p> */}
                  </div>
                  {/* <div>
                    <h2 className="text-2xl font-bold text-pink-800 mb-4">Our Expertise</h2>
                    <ul className="text-pink-700 space-y-3">
                      ...
                      <li className="flex items-center">
                        <span className="w-2 h-2 bg-pink-500 rounded-full mr-3"></span>
                        Bulk ordering and corporate discounts
                      </li>
                    </ul>
                  </div> */}
                </div>
            ...
            <div className="mb-6 px-2">
              <p className="text-pink-700 font-semibold">
                Showing {filteredImages.length} of {giftImages.length} gift options
                {searchTerm && (
            ...
            {filteredImages.length > 0 ? (
              ...
              <div className="text-center py-16 bg-gradient-to-br from-pink-50 to-white rounded-2xl border border-pink-100">
                ...
                <h3 className="text-2xl font-bold text-pink-900 mb-3">No gifts found</h3>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            {/* Close Button */}
            <button 
              className="absolute top-4 right-4 bg-white/90 hover:bg-white text-pink-900 rounded-full p-2 z-20 shadow-lg hover:shadow-xl transition-all duration-200"
              onClick={closeModal}
            >

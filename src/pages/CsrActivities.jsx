...
const CsrActivities = () => {
  ...
  const csrImages = [
    {
      ...
      description: "Environmental conservation through large-scale tree plantation drives and ecological awareness programs"
    },
    {
      id: 2,
      ...
      category: "education",
      description: "Empowering underprivileged children through educational support, scholarships, and school infrastructure development"
    },
    {
      id: 3,
      ...
      category: "healthcare",
      description: "Free medical checkups, health awareness camps, and healthcare services for underserved communities"
    },
    {
      id: 4,
    ...
    },
    {
      ...
      category: "sanitation",
      description: "Providing access to clean drinking water and sanitation facilities in rural and underserved areas"
    },
    {
      id: 6,
      ...
      category: "empowerment",
      description: "Initiatives focused on women's education, financial independence, and leadership development"
    }
  ];
  ...
  const openModal = (image) => {
    const index = csrImages.findIndex((img) => img.id === image.id);
  ...
  const nextImage = () => {
    const nextIndex = (currentIndex + 1) % csrImages.length;
    setCurrentIndex(nextIndex);
    setSelectedImage(csrImages[nextIndex]);
  };

  const prevImage = () => {
    const prevIndex = currentIndex === 0 ? csrImages.length - 1 : currentIndex - 1;
    setCurrentIndex(prevIndex);
    setSelectedImage(csrImages[prevIndex]);
  };
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-pink-25 rounded-2xl p-8 mb-8 shadow-lg border border-pink-100">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-pink-700 mb-6 leading-relaxed">
                  We partner with organizations to create sustainable change in education, environment, 
                  healthcare, and community development through comprehensive CSR programs that make 
                ...
                <div className="relative max-w-md">
                  ...
                  <input
                    type="text"
                    placeholder="Search activities by title, category..."
                    value={searchTerm}
            ...
            <div className="mb-6 px-2">
              <p className="text-pink-700 font-semibold">
                Showing {filteredImages.length} of {csrImages.length} CSR activities
                {searchTerm && (
            ...
            {filteredImages.length > 0 ? (
              ...
              <div className="text-center py-16 bg-gradient-to-br from-pink-50 to-white rounded-2xl border border-pink-100">
                ...
                <h3 className="text-2xl font-bold text-pink-900 mb-3">No activities found</h3>
                <p className="text-pink-700 text-lg max-w-md mx-auto">
                  Try adjusting your search terms or browse all CSR activity categories
                </p>
                {searchTerm && (
                  <button 
          ...
          >
            ...
            {csrImages.length > 1 && (
              <div className="absolute top-4 left-4 bg-black/50 text-white px-3 py-1 rounded-full text-sm font-semibold z-20">
                {currentIndex + 1} / {csrImages.length}
              </div>
            )}

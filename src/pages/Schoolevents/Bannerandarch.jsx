...
// Importing Images
import b1 from "../../assets/School/BannersandArch/b1.png";
import b2 from "../../assets/School/BannersandArch/b2.png";
import b3 from "../../assets/School/BannersandArch/b3.png";
import b4 from "../../assets/School/BannersandArch/b4.png";
import b5 from "../../assets/School/BannersandArch/b5.png";
import b6 from "../../assets/School/BannersandArch/b6.png";
import b7 from "../../assets/School/BannersandArch/b7.png";
import b8 from "../../assets/School/BannersandArch/b8.png";
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "BannerAndArch" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image) => (
              ...
              >
                <img
                  src={image.src}
                  alt={`Banner and Arch Design ${image.id}`}

...
// Importing Images
import serial1 from "../../assets/School/Stage/s1.png";
import serial2 from "../../assets/School/Stage/s2.png";
import serial3 from "../../assets/School/Stage/s3.png";
import serial4 from "../../assets/School/Stage/s4.png";
import serial5 from "../../assets/School/Stage/s5.png";
import serial6 from "../../assets/School/Stage/s6.png";
import serial7 from "../../assets/School/Stage/s7.png";
import serial8 from "../../assets/School/Stage/s8.png";
import serial9 from "../../assets/School/Stage/s9.png";
import serial10 from "../../assets/School/Stage/s10.png";
import serial11 from "../../assets/School/Stage/s11.png";
import serial12 from "../../assets/School/Stage/s12.png";
import serial13 from "../../assets/School/Stage/s13.png";
import serial14 from "../../assets/School/Stage/s14.png";
import serial15 from "../../assets/School/Stage/s15.png";
...
const Stage = () => {
  ...
  // Updated naming to PascalCase so the regex adds spaces correctly in the UI
  const quickLinks = [
    "Stage",
    "LightAndSound",
    "ShedOrTent",
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "Stage" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
                    {/* Replaces PascalCase with Space Separated Words (e.g., LightAndSound -> Light And Sound) */}

...
// Importing Images
// Renamed variables to 'st' (Shed/Tent) to avoid confusion with Light & Sound
import st1 from "../../assets/School/Shed/S1.png";
import st2 from "../../assets/School/Shed/S2.png";
import st3 from "../../assets/School/Shed/S3.png";
// Assuming S4 exists or using a placeholder if missing in your folder
import st5 from "../../assets/School/Shed/S5.png";
import st6 from "../../assets/School/Shed/S6.png";
import st7 from "../../assets/School/Shed/S7.png";
...
const ShedOrTent = () => {
  ...
  // Updated to PascalCase for correct spacing in Sidebar
  const quickLinks = [
    "Stage",
    "LightAndSound",
    "ShedOrTent",
  ...
  const images = [
    ...
    { id: 2, src: st2 },
    { id: 3, src: st3 },
    { id: 4, src: st1 }, // Placeholder (Reusing st1) to fill grid - replace with S4 if available
    { id: 5, src: st5 },
    { id: 6, src: st6 },
    { id: 7, src: st7 },
    { id: 8, src: st2 }, // Placeholder to demonstrate 4-column layout
  ];
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "ShedOrTent" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
                    {/* Regex splits PascalCase into words: "ShedOrTent" -> "Shed Or Tent" */}

...
// Importing Images
import c1 from "../../assets/School/Carnival/c1.png";
import c2 from "../../assets/School/Carnival/s2.png";
import c3 from "../../assets/School/Carnival/s3.png";
import c4 from "../../assets/School/Carnival/s5.png";
...
const Carnival = () => {
  ...
  // Image Data
  // Added duplicates to demonstrate the 4-column grid layout
  const images = [
    { id: 1, src: c1 },
    { id: 2, src: c2 },
    { id: 3, src: c3 },
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "Carnival" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >

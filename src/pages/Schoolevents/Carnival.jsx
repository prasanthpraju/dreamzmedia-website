...
const Carnival = () => {
  ...
  const images = [
    { id: 1, src: "https://images.unsplash.com/photo-1533237264986-641521d3c95d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" },
    { id: 2, src: "https://images.unsplash.com/photo-1515168833906-d2d02fb8d485?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" },
    { id: 3, src: "https://images.unsplash.com/photo-1531058020387-3be344556be6?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" },
    { id: 4, src: "https://images.unsplash.com/photo-1511882150382-421056c89033?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80" },
    { id: 5, src: "https://images.unsplash.com/photo-1542751371-adc38448a05e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" },
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <div className="pt-32 pb-12 px-6 text-center border-b border-gray-100">
        <h1 className="text-5xl md:text-7xl font-serif font-bold text-gray-900 tracking-tight mb-4">Carnival</h1>
          ...
          <div className="sticky top-32">
            ...
            <ul className="space-y-4">
              {quickLinks.map((link, idx) => (
                <li key={idx}>
                  <button onClick={() => navigate(`/${link.toLowerCase().replace(/\s+/g, '-')}`)} className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${link === 'Carnival' ? 'text-pink-900' : 'text-gray-400'}`}>

...
// Importing Images
import v1 from "../../assets/School/Videography/v1.png";
import v2 from "../../assets/School/Videography/v2.png";
import v3 from "../../assets/School/Videography/v3.png";
import v4 from "../../assets/School/Videography/v4.png";
import v5 from "../../assets/School/Videography/v5.png";
import v6 from "../../assets/School/Videography/v6.png";
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="pt-32 pb-12 px-6 text-center border-b border-gray-100">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-gray-900 tracking-tight mb-4">
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "VideographyAndPhotography" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image) => (
              ...
              >
                <img
                  src={image.src}
                  alt={`Videography & Photography ${image.id}`}

...
// Importing Images
import t1 from "../../assets/School/Trophiesandgifts/t1.png";
import t2 from "../../assets/School/Trophiesandgifts/t2.png";
import t3 from "../../assets/School/Trophiesandgifts/t3.png";
import t4 from "../../assets/School/Trophiesandgifts/t4.png";
import t5 from "../../assets/School/Trophiesandgifts/t5.png";
import t6 from "../../assets/School/Trophiesandgifts/t6.png";
import t7 from "../../assets/School/Trophiesandgifts/t7.png";
import t8 from "../../assets/School/Trophiesandgifts/t8.png";
...
const TrophiesAndGift = () => {
  ...
  // Updated to PascalCase so spaces are inserted correctly in the sidebar
  const quickLinks = [
    "Stage",
    "LightAndSound",
    "ShedOrTent",
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "TrophiesAndGift" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
                    {/* Regex splits PascalCase into words */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image) => (
              ...
              >
                <img
                  src={image.src}
                  alt={`Trophy or Gift Item ${image.id}`}

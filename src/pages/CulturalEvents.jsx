  ...
  const culturalImages = [
    {
      ...
      category: "dance",
      description: "Captivating traditional dance performances showcasing rich cultural heritage and artistic expression"
    },
    {
      id: 2,
      ...
      title: "Music Concert",
      category: "music",
      description: "Soulful music concerts featuring traditional and contemporary musical performances"
    },
    {
      id: 3,
      src: "https://images.unsplash.com/photo-1503095396549-807759245b35?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80",
      title: "Drama Theater",
      category: "theater",
      description: "Engaging theatrical performances that bring stories and cultural narratives to life"
    },
    {
      id: 4,
      ...
      category: "festival",
      description: "Vibrant festival celebrations featuring cultural rituals, food, and community gatherings"
    },
    {
      id: 5,
      ...
      category: "art",
      description: "Curated art exhibitions showcasing traditional and contemporary cultural artworks"
    },
    {
      id: 6,
      src: "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80",
      title: "Cultural Workshop",
      category: "workshop",
      description: "Interactive workshops teaching traditional arts, crafts, and cultural practices"
    }
  ];

  const filteredImages = culturalImages.filter(image =>
          ...
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-pink-25 rounded-2xl p-8 mb-8 shadow-lg border border-pink-100">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-pink-700 mb-6 leading-relaxed">
                  From traditional performances to contemporary art exhibitions, 
                  we bring cultural experiences that inspire, educate, and connect communities 
                  through authentic artistic expressions.
                </p>
            ...
            <div className="mb-6 px-2">
              <p className="text-pink-700 font-semibold">
                Showing {filteredImages.length} of {culturalImages.length} cultural events
                {searchTerm && (
            ...
            {filteredImages.length > 0 ? (
              ...
              <div className="text-center py-16 bg-gradient-to-br from-pink-50 to-white rounded-2xl border border-pink-100">
                ...
                <h3 className="text-2xl font-bold text-pink-900 mb-3">No events found</h3>
                <p className="text-pink-700 text-lg max-w-md mx-auto">
                  Try adjusting your search terms or browse all cultural event categories
                </p>
                {searchTerm && (
                  <button 

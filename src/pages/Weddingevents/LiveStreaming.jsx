...
// Importing Images
// Renamed variables to 'ls' (Live Streaming) for code clarity
import ls1 from "../../assets/WeddingPlanner/LiveStreaming/l1.png";
import ls2 from "../../assets/WeddingPlanner/LiveStreaming/l2.png";
import ls3 from "../../assets/WeddingPlanner/LiveStreaming/l3.png";
import ls4 from "../../assets/WeddingPlanner/LiveStreaming/l4.png";
import ls5 from "../../assets/WeddingPlanner/LiveStreaming/l5.png";
import ls6 from "../../assets/WeddingPlanner/LiveStreaming/l6.png";
import ls7 from "../../assets/WeddingPlanner/LiveStreaming/l7.png";
import ls8 from "../../assets/WeddingPlanner/LiveStreaming/l8.png";
import ls9 from "../../assets/WeddingPlanner/LiveStreaming/l9.png";
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "LiveStreaming" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image) => (
              ...
              >
                <img
                  src={image.src}
                  alt={`Live Stream Setup ${image.id}`}

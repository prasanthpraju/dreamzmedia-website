...
// Importing Images
import b1 from "../../assets/WeddingPlanner/Beautician/b1.png";
import b2 from "../../assets/WeddingPlanner/Beautician/b2.png";
import b3 from "../../assets/WeddingPlanner/Beautician/b3.png";
import b4 from "../../assets/WeddingPlanner/Beautician/b4.png";
import b5 from "../../assets/WeddingPlanner/Beautician/b5.png";
import b6 from "../../assets/WeddingPlanner/Beautician/b6.png";
import b7 from "../../assets/WeddingPlanner/Beautician/b7.png";
import b8 from "../../assets/WeddingPlanner/Beautician/b8.png";
import b9 from "../../assets/WeddingPlanner/Beautician/b9.png";
import b10 from "../../assets/WeddingPlanner/Beautician/b10.png";
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "Beautician" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image) => (
              ...
              >
                <img
                  src={image.src}
                  alt={`Beautician Portfolio ${image.id}`}

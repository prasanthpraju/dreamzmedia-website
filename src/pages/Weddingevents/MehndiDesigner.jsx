...
// Importing Images
import md1 from "../../assets/WeddingPlanner/Mehndidesigner/m1.png";
import md2 from "../../assets/WeddingPlanner/Mehndidesigner/m2.png";
import md3 from "../../assets/WeddingPlanner/Mehndidesigner/m3.png";
import md4 from "../../assets/WeddingPlanner/Mehndidesigner/m4.png";
import md5 from "../../assets/WeddingPlanner/Mehndidesigner/m5.png";
import md6 from "../../assets/WeddingPlanner/Mehndidesigner/m6.png";
import md7 from "../../assets/WeddingPlanner/Mehndidesigner/m7.png";
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "MehndiDesigner" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >

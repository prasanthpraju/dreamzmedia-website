...
import mc1 from "../../assets/WeddingPlanner/marriagecard/mc.png";
import mc2 from "../../assets/WeddingPlanner/marriagecard/mc1.png";
import mc3 from "../../assets/WeddingPlanner/marriagecard/mc2.png";
import mc4 from "../../assets/WeddingPlanner/marriagecard/mc3.png";

import mc6 from "../../assets/WeddingPlanner/marriagecard/mc5.png";
import mc7 from "../../assets/WeddingPlanner/marriagecard/mc6.png";
import mc8 from "../../assets/WeddingPlanner/marriagecard/mc7.png";
import mc9 from "../../assets/WeddingPlanner/marriagecard/mc8.png";
import mc10 from "../../assets/WeddingPlanner/marriagecard/mc9.png";
              ...
              {quickLinks.map((link, idx) => (
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${link === "MarriageCard" ? "text-pink-900" : "text-gray-400"}`}
                  >

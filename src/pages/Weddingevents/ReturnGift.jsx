...
// Importing Images
// Make sure you have these images in your assets folder, or remove the extras from the array below
import rg1 from "../../assets/WeddingPlanner/ReturnGift/r1.png";
import rg2 from "../../assets/WeddingPlanner/ReturnGift/r2.png";
// Added placeholders for demonstration - ensure these files exist or remove them from the 'images' array
import rg3 from "../../assets/WeddingPlanner/ReturnGift/r1.png"; 
import rg4 from "../../assets/WeddingPlanner/ReturnGift/r2.png";
import rg5 from "../../assets/WeddingPlanner/ReturnGift/r1.png";
import rg6 from "../../assets/WeddingPlanner/ReturnGift/r2.png";
import rg7 from "../../assets/WeddingPlanner/ReturnGift/r1.png";
import rg8 from "../../assets/WeddingPlanner/ReturnGift/r2.png";
                ...
                <li key={idx}>
                  <button
                    ...
                    className={`text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:text-pink-900 hover:translate-x-2 cursor-pointer w-full text-left ${
                      link === "ReturnGift" ? "text-pink-900" : "text-gray-400"
                    }`}
                  >

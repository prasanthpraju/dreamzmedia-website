...
const About = () => {
  ...
  const features = [
    {
      ...
      description: "Meticulous attention to detail ensures every aspect of your event is perfectly executed."
    },
    {
    ...
    },
    {
      ...
      description: "We respect deadlines and deliver exceptional results on time, every time."
    },
    {
      title: "Quality Assurance",
      description: "Rigorous quality checks ensure every event meets our high standards."
    }
  ];
  ...
  const processSteps = [
    {
      step: "01",
      title: "Consultation",
      description: "We understand your vision, requirements, and budget to create a customized plan."
    },
    {
      step: "02",
      title: "Planning",
      description: "Detailed event planning with timelines, budgets, and creative concepts."
    },
    {
      step: "03",
      title: "Execution",
      description: "Seamless implementation with professional team and quality vendors."
    },
    {
      step: "04",
      title: "Delivery",
      description: "Perfect event execution with post-event follow-up and feedback."
    }
  ];
  ...
  const services = [
    ...
    },
    {
      ...
      items: ["Exhibitions", "Award Ceremonies", "Fashion Shows", "Charity Events"]
    }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className={`text-center mb-16 lg:mb-20 transform transition-all duration-1000 delay-300 ${
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-16 lg:mb-20">
          ...
          <div className="space-y-8 lg:space-y-10">
            ...
            <div className={`space-y-6 transform transition-all duration-700 delay-500 ${
              ...
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
                Your Vision, <span className="text-pink-900">Our Expertise</span>
              </h3>
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed lg:leading-loose">
                ...
                expertise to deliver events that not only meet but surpass your expectations. 
                From intimate gatherings to large-scale corporate functions, we handle 
              ...
              {features.map((feature, index) => (
                <div 
                  ...
                  className={`bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 transform ${
                    isVisible ? 'translate-y-0 opacity-100 hover:-translate-y-2' : 'translate-y-10 opacity-0'
                  }`}
                  style={{
            ...
            {/* Process Steps */}
            <div className={`space-y-6 transform transition-all duration-700 delay-900 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
          ...
          <div className="space-y-8 lg:space-y-10">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-50 p-8 rounded-2xl shadow-lg border border-pink-100 hover:shadow-xl transition-all duration-500">
                ...
                <ul className="space-y-4">
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <span className="text-pink-900 text-lg mr-4 mt-0.5 flex-shrink-0">✓</span>
            ...
            {/* Services Offered */}
            <div className={`bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 transform ${
              isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
            }`}>
              <h4 className="text-2xl font-bold text-gray-900 mb-6">Our Services</h4>
              <div className="grid gap-6">
                {services.map((service, index) => (
                  <div key={service.title} className="border-l-4 border-pink-900 pl-4">
            ...
            <div className={`space-y-6 transform transition-all duration-700 delay-800 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              <h4 className="text-2xl font-bold text-gray-900 text-center">Our Achievements</h4>
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Events Managed</div>
                </div>
                <div className="text-center p-6 bg-white/50 rounded-2xl backdrop-blur-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
                  <div className="text-3xl lg:text-4xl font-bold text-pink-900 mb-2 transition-all duration-500">
                    {counters.clients}+
            ...
            {/* Team Stats */}
            <div className={`grid grid-cols-2 gap-4 transform transition-all duration-700 delay-1000 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              {teamStats.map((stat, index) => (
                <div key={stat.label} className="text-center p-4 bg-white/30 rounded-xl backdrop-blur-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
                  <div className="text-xl lg:text-2xl font-bold text-pink-900 mb-1">{stat.number}</div>
        ...
        <div className={`grid md:grid-cols-2 gap-8 mb-16 lg:mb-20 transform transition-all duration-1000 delay-1100 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              To redefine event management standards by delivering bespoke solutions that 
              blend creativity with flawless execution. We believe every event tells a 
              story, and we're here to make yours unforgettable.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              To be Chennai's most trusted event management partner, known for innovation, 
              reliability, and creating magical experiences that leave lasting impressions 
              on every client and guest.
            </p>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .animate-orb-move { animation: orb-move 25s ease-in-out infinite; }
        .animate-grid-move { animation: grid-move 25s linear infinite; }
        
        .bg-grid-pattern {
          background-image: linear-gradient(rgba(244, 114, 182, 0.08) 1px, transparent 1px),

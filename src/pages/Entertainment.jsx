...
const Entertainment = () => {
  ...
  const filteredImages = entertainmentImages.filter(image =>
  ...
  return (
    <div className="entertainment-page">
      <div className="entertainment-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Entertainment</h2>
          
          <p className="content-description">
            Make your wedding celebrations unforgettable with our diverse entertainment options. 
            From live music and dance performances to magic shows and fireworks, we keep your 
            guests engaged and create lasting memories.
          </p>
          ...
          {filteredImages.length === 0 && (
            <div className="no-results">
              <p>No entertainment options found matching your search.</p>
            </div>
          )}
        </div>
      </div>

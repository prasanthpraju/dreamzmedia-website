...
const Wedding = () => {
  ...
  const filteredImages = weddingImages.filter(image =>
    ...
    <div className="wedding-page">
      <div className="wedding-content-wrapper">
        ...
        <div className="content-area">
          <h2 className="content-title">Wedding Photography</h2>
          
          <p className="content-description">
            Capture your special moments with our professional wedding photography services. 
            From candid shots to traditional ceremonies, we preserve your beautiful memories 
          ...
          {filteredImages.length === 0 && (
            <div className="no-results">
              <p>No wedding photography found matching your search.</p>
            </div>
          )}
        </div>
      </div>
